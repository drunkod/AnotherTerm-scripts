...
https://github.com/drunkod/coder-core/releases/download/20230410-075617/restreamer-rootfs.tar.gz from arm64 build
restreamer test
`( export ROOTFS_URL="https://github.com/drunkod/coder-core/releases/download/20230410-075617/restreamer-rootfs.tar.gz" ; S=install-linuxcontainers.sh ; "$TERMSH" copy -f -fu "https://raw.githubusercontent.com/drunkod/AnotherTerm-scripts/master/$S" -tp . && chmod 755 $S && sh ./$S -a alpine 3.17 )`
